...
export default function Start(props){
    return (
         <div className = "intro-page">
            <svg className="top-right" xmlns="http://www.w3.org/2000/svg" width="158" height="141" viewBox="0 0 158 141"  fill="none">
            ...
            <h3>Quizzical</h3>
            <p>Conquer your cluelessness with the ingenious quiz app that helps you learn about the questions</p>
            <button className="start-btn" id="start-btn" onClick = {props.onStartQuiz}>Start quiz</button>
             
            <svg className="bottom-left" xmlns="http://www.w3.org/2000/svg" width="148" height="118" viewBox="0 0 148 118" fill="none">
